...
const TRANSLATIONS = {
  en: {
    ...
    bundle_sub: 'Add ScriptWala to a website package after discussing the full requirement on WhatsApp.',
  ...
  hi: {
    ...
    bundle_sub: 'Website package के साथ ScriptWala जोड़ने के लिए पूरा requirement WhatsApp पर discuss करें।',
  ...
  as: {
    ...
    bundle_sub: 'Website package-ৰ সৈতে ScriptWala যোগ কৰাৰ আগতে WhatsApp-ত সম্পূৰ্ণ requirement আলোচনা কৰক।',
