...
# 2. Replace description and add new meta tags
html = html.replace(
...
schema = '''    <!-- LocalBusiness Structured Data (SEO) -->
    <script type="application/ld+json">
    {
      ...
      "@type": "LocalBusiness",
      "name": "Smart Digital",
      "image": "https://smartdigitalassam.com/assets/img/logo.png",
      "@id": "https://smartdigitalassam.com/",
      "url": "https://smartdigitalassam.com/",
...
# Handle the minified </head> on line 38
# The line has: <link rel="stylesheet" href="chatbot/bot.css"></head>
html = html.replace(
    '<link rel="stylesheet" href="chatbot/bot.css"></head>',
...
print('Done! SEO tags and schema updated in index.html.')
